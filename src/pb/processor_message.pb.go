...
type CPU struct {
	...
	Brand         string  `protobuf:"bytes,1,opt,name=brand,proto3" json:"brand,omitempty"` // brand of the cpu
	Name          string  `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`   // name of the cpu
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
